...
// xem history của user f1 ở phía user

export default function UserF1History({ history, match }) {
  ...
  if (history.action === "POP") {
    return <Redirect to={"/user/account-management"} />;
  }
  ...
  return (
    <div className="chart-history">
      <div className="breadcrumb">
        <Breadcrumb>
          <Breadcrumb.Item>
            <span style={{ cursor: "pointer" }} onClick={() => history.replace("/user/account-management")}>
              Account Management
            </span>
          </Breadcrumb.Item>
          <Breadcrumb.Item>User F1 ID: {uid}</Breadcrumb.Item>
        </Breadcrumb>
      </div>
